            ...
            <div class="panel-body">
                <form class="form-horizontal" method="post" action="javascript:void(0)" id="frm-create-book">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <textarea class="form-control" id="text_description" name="text_description"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input type="button" type="button" value="Upload Image" class="form-control"
                                name="txt_image" id="txt_image">
